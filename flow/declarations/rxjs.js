// edited flow-typed type declarations
// TODO: Open PR with updates once all errors on our side are resolved
...
declare module "rxjs/operators" {
  declare module.exports: {
    ...
    filter<+T, U>(predicate: (value: T, index: number) => boolean,
                      thisArg?: any): rxjs$Observable<T> => rxjs$Observable<U>;
    ...
    pluck<+T, K: $Keys<T>>(key: K & string): rxjs$Observable<T> => rxjs$Observable<$ElementType<T, K>>;
