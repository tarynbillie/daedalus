...
declare module 'electron' {
  declare var app: App;
  declare var autoUpdater: AutoUpdater;
  declare var clipboard: Clipboard;
  declare var contentTracing: ContentTracing;
  declare var crashReporter: CrashReporter;
  declare var desktopCapturer: DesktopCapturer;
  ...
  declare var nativeImage: typeof NativeImage;
  declare var net: Net;
  declare var powerMonitor: PowerMonitor;
  declare var powerSaveBlocker: PowerSaveBlocker;
  declare var protocol: Protocol;
  declare var remote: Remote;
  declare var screen: Screen;
  declare var session: typeof Session;
  declare var shell: Shell;
  declare var systemPreferences: SystemPreferences;
  declare var webContents: typeof WebContents;
  declare var webFrame: WebFrame;
  declare var webviewTag: WebviewTag;
  ...
  declare class Accelerator extends String {}
  ...
  declare interface MainInterface extends CommonInterface {
    app: App;
  ...
  declare interface RendererInterface extends CommonInterface {
  ...
  declare interface AllElectron extends MainInterface, RendererInterface {}

  declare interface App extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/app
    // TODO: type events properly
    // /**
    ...
    //  * CFBundleURLTypes key, and set NSPrincipaldeclare class to AtomApplication. You should
  ...
  declare interface AutoUpdater extends EventEmitter {
  ...
  declare class BrowserView extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/browser-view

    constructor(options?: BrowserViewConstructorOptions): BrowserView;
  ...
  declare class BrowserWindow extends EventEmitter {
    ...
    // once(event: 'page-title-updated', listener: (event: Event, title: string) => void): this;
    // addListener(event: 'page-title-updated', listener: (event: Event, title: string) => void): this;
    // removeListener(event: 'page-title-updated', listener: (event: Event, title: string) => void): this;
    // /**
  ...
  declare class BrowserWindowProxy extends EventEmitter {
  ...
  declare interface CertificatePrincipal {
  ...
  declare interface Clipboard extends EventEmitter {
  ...
  declare interface ContentTracing extends EventEmitter {
  ...
  declare class Cookies extends EventEmitter {
  ...
  declare interface CrashReporter extends EventEmitter {
  ...
  declare interface DesktopCapturer extends EventEmitter {
  ...
  declare interface Dialog extends EventEmitter {
  ...
  declare class DownloadItem extends EventEmitter {
    ...
    //  */
    // on(event: 'done', listener: (event: Event, state: string) => void): this;
    // once(event: 'done', listener: (event: Event, state: string) => void): this;
    // addListener(event: 'done', listener: (event: Event, state: string) => void): this;
    // removeListener(event: 'done', listener: (event: Event, state: string) => void): this;
    // /**
    //  * Emitted when the download has been updated and is not done. The state can be one
    //  * of following:
    //  */
    // on(event: 'updated', listener: (event: Event, state: string) => void): this;
    // once(event: 'updated', listener: (event: Event, state: string) => void): this;
    // addListener(event: 'updated', listener: (event: Event, state: string) => void): this;
    // removeListener(event: 'updated', listener: (event: Event, state: string) => void): this;
    /**
  ...
  declare interface GlobalShortcut extends EventEmitter {
  ...
  declare interface GPUFeatureStatus {
  ...
  declare interface IpcMain extends EventEmitter {
  ...
  declare interface IpcRenderer extends EventEmitter {
  ...
  declare interface MemoryUsageDetails {
  ...
  declare class MenuItem {
    ...
    constructor(options: MenuItemConstructorOptions): MenuItem;
    checked: boolean;
    click: Function;
    enabled: boolean;
    label: string;
  ...
  declare interface MimeTypedBuffer {
  ...
  declare interface Net extends EventEmitter {
  ...
  declare interface PowerMonitor extends EventEmitter {
  ...
  declare interface PowerSaveBlocker extends EventEmitter {
  ...
  declare interface ProcessMetric {
  ...
  declare interface Protocol extends EventEmitter {
    ...
    registerBufferProtocol(
      scheme: string,
      handler: (request: RegisterBufferProtocolRequest, callback: (buffer?: Buffer | MimeTypedBuffer) => void) => void,
      completion?: (error: Error) => void,
    ): void;
    /**
  ...
  declare interface Remote extends MainInterface {
  ...
  declare interface RemoveClientCertificate {
  ...
  declare interface RemovePassword {
  ...
  declare interface Screen extends EventEmitter {
  ...
  declare interface ScrubberItem {
  ...
  declare interface SegmentedControlSegment {
  ...
  declare class Session extends EventEmitter {
    ...
    setPermissionRequestHandler(
      handler: (webContents: WebContents, permission: string, callback: (permissionGranted: boolean) => void) => void,
    ): void;
    /**
  ...
  declare interface ShortcutDetails {
  ...
  declare interface SystemPreferences extends EventEmitter {
  ...
  declare class TouchBarButton extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/touch-bar-button

    constructor(options: TouchBarButtonConstructorOptions): TouchBarButton;
    backgroundColor: string;
    icon: NativeImage;
    label: string;
  }

  declare class TouchBarColorPicker extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/touch-bar-color-picker

    constructor(options: TouchBarColorPickerConstructorOptions): TouchBarColorPicker;
    availableColors: string[];
    selectedColor: string;
  }

  declare class TouchBarGroup extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/touch-bar-group

    constructor(options: TouchBarGroupConstructorOptions): TouchBarGroup;
  }

  declare class TouchBarLabel extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/touch-bar-label

    constructor(options: TouchBarLabelConstructorOptions): TouchBarLabel;
    label: string;
    textColor: string;
  }

  declare class TouchBarPopover extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/touch-bar-popover

    constructor(options: TouchBarPopoverConstructorOptions): TouchBarPopover;
    icon: NativeImage;
    label: string;
  }

  declare class TouchBarScrubber extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/touch-bar-scrubber

    constructor(options: TouchBarScrubberConstructorOptions): TouchBarScrubber;
    continuous: boolean;
    items: ScrubberItem[];
    mode: string;
    overlayStyle: string;
  ...
  declare class TouchBarSegmentedControl extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/touch-bar-segmented-control

    constructor(options: TouchBarSegmentedControlConstructorOptions): TouchBarSegmentedControl;
    segments: SegmentedControlSegment[];
    segmentStyle: string;
    selectedIndex: number;
  }

  declare class TouchBarSlider extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/touch-bar-slider

    constructor(options: TouchBarSliderConstructorOptions): TouchBarSlider;
    label: string;
    maxValue: number;
    minValue: number;
    value: number;
  ...
  declare class TouchBarSpacer extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/touch-bar-spacer

    constructor(options: TouchBarSpacerConstructorOptions): TouchBarSpacer;
  }

  declare class TouchBar extends EventEmitter {
    // Docs: http://electron.atom.io/docs/api/touch-bar

    constructor(options: TouchBarConstructorOptions): TouchBar;
    escapeItem: any;
  ...
  declare interface UploadFileSystem {
  ...
  declare interface UploadRawData {
  ...
  declare class WebContents extends EventEmitter {
    ...
    // once(event: 'did-frame-finish-load', listener: (event: Event, isMainFrame: boolean) => void): this;
    // addListener(event: 'did-frame-finish-load', listener: (event: Event, isMainFrame: boolean) => void): this;
    // removeListener(event: 'did-frame-finish-load', listener: (event: Event, isMainFrame: boolean) => void): this;
    // /**
    ...
    // once(event: 'did-navigate', listener: (event: Event, url: string) => void): this;
    // addListener(event: 'did-navigate', listener: (event: Event, url: string) => void): this;
    // removeListener(event: 'did-navigate', listener: (event: Event, url: string) => void): this;
    // /**
    ...
    // once(event: 'did-navigate-in-page', listener: (event: Event, url: string, isMainFrame: boolean) => void): this;
    // addListener(
  ...
  declare interface WebFrame extends EventEmitter {
  ...
  declare class WebRequest extends EventEmitter {
  ...
  declare interface WebviewTag extends HTMLElement {
     ...
     */
    // addEventListener(event: 'load-commit', listener: (event: LoadCommitEvent) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'load-commit', listener: (event: LoadCommitEvent) => void): WebviewTag;
    /**
     * Fired when the navigation is done, i.e. the spinner of the tab will stop
     * spinning, and the onload event is dispatched.
     */
    // addEventListener(event: 'did-finish-load', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'did-finish-load', listener: (event: Event) => void): WebviewTag;
    /**
     * This event is like did-finish-load, but fired when the load failed or was
     * cancelled, e.g. window.stop() is invoked.
     */
    // addEventListener(event: 'did-fail-load', listener: (event: DidFailLoadEvent) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'did-fail-load', listener: (event: DidFailLoadEvent) => void): WebviewTag;
    /**
    ...
    //   useCapture?: boolean,
    // ): WebviewTag;
    // removeEventListener(event: 'did-frame-finish-load', listener: (event: DidFrameFinishLoadEvent) => void): WebviewTag;
    /**
     * Corresponds to the points in time when the spinner of the tab starts spinning.
     */
    // addEventListener(event: 'did-start-loading', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'did-start-loading', listener: (event: Event) => void): WebviewTag;
    /**
     * Corresponds to the points in time when the spinner of the tab stops spinning.
     */
    // addEventListener(event: 'did-stop-loading', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'did-stop-loading', listener: (event: Event) => void): WebviewTag;
    /**
    ...
    // addEventListener(
    //   event: 'did-get-response-details',
    //   listener: (event: DidGetResponseDetailsEvent) => void,
    //   useCapture?: boolean,
    // ): WebviewTag;
    // removeEventListener(event: 'did-get-response-details', listener: (event: DidGetResponseDetailsEvent) => void): WebviewTag;
    /**
     * Fired when a redirect was received while requesting a resource.
     */
    // addEventListener(
    //   event: 'did-get-redirect-request',
    //   listener: (event: DidGetRedirectRequestEvent) => void,
    //   useCapture?: boolean,
    // ): WebviewTag;
    // removeEventListener(event: 'did-get-redirect-request', listener: (event: DidGetRedirectRequestEvent) => void): WebviewTag;
    /**
     * Fired when document in the given frame is loaded.
     */
    // addEventListener(event: 'dom-ready', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'dom-ready', listener: (event: Event) => void): WebviewTag;
    /**
    ...
    //   useCapture?: boolean,
    // ): WebviewTag;
    // removeEventListener(event: 'page-title-updated', listener: (event: PageTitleUpdatedEvent) => void): WebviewTag;
    /**
    ...
    //   useCapture?: boolean,
    // ): WebviewTag;
    // removeEventListener(event: 'page-favicon-updated', listener: (event: PageFaviconUpdatedEvent) => void): WebviewTag;
    /**
     * Fired when page enters fullscreen triggered by HTML API.
     */
    // addEventListener(event: 'enter-html-full-screen', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'enter-html-full-screen', listener: (event: Event) => void): WebviewTag;
    /**
     * Fired when page leaves fullscreen triggered by HTML API.
     */
    // addEventListener(event: 'leave-html-full-screen', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'leave-html-full-screen', listener: (event: Event) => void): WebviewTag;
    /**
    ...
    //   useCapture?: boolean,
    // ): WebviewTag;
    // removeEventListener(event: 'console-message', listener: (event: ConsoleMessageEvent) => void): WebviewTag;
    /**
     * Fired when a result is available for webview.findInPage request.
     */
    // addEventListener(event: 'found-in-page', listener: (event: FoundInPageEvent) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'found-in-page', listener: (event: FoundInPageEvent) => void): WebviewTag;
    /**
     ...
     */
    // addEventListener(event: 'new-window', listener: (event: NewWindowEvent) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'new-window', listener: (event: NewWindowEvent) => void): WebviewTag;
    /**
     * Emitted when a user or the page wants to start navigation. It can happen when
     * the window.location object is changed or a user clicks a link in the page. This
     * event will not emit when the navigation is started programmatically with APIs
     ...
     */
    // addEventListener(event: 'will-navigate', listener: (event: WillNavigateEvent) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'will-navigate', listener: (event: WillNavigateEvent) => void): WebviewTag;
    /**
     * Emitted when a navigation is done. This event is not emitted for in-page
     * navigations, such as clicking anchor links or updating the window.location.hash.
     * Use did-navigate-in-page event for this purpose.
     */
    // addEventListener(event: 'did-navigate', listener: (event: DidNavigateEvent) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'did-navigate', listener: (event: DidNavigateEvent) => void): WebviewTag;
    /**
     * Emitted when an in-page navigation happened. When in-page navigation happens,
     * the page URL changes but does not cause navigation outside of the page. Examples
     * of this occurring are when anchor links are clicked or when the DOM hashchange
    ...
    //   useCapture?: boolean,
    // ): WebviewTag;
    // removeEventListener(event: 'did-navigate-in-page', listener: (event: DidNavigateInPageEvent) => void): WebviewTag;
    /**
     ...
     */
    // addEventListener(event: 'close', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'close', listener: (event: Event) => void): WebviewTag;
    /**
     ...
     */
    // addEventListener(event: 'ipc-message', listener: (event: IpcMessageEvent) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'ipc-message', listener: (event: IpcMessageEvent) => void): WebviewTag;
    /**
     * Fired when the renderer process is crashed.
     */
    // addEventListener(event: 'crashed', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'crashed', listener: (event: Event) => void): WebviewTag;
    /**
     * Fired when the gpu process is crashed.
     */
    // addEventListener(event: 'gpu-crashed', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'gpu-crashed', listener: (event: Event) => void): WebviewTag;
    /**
    ...
    //   useCapture?: boolean,
    // ): WebviewTag;
    // removeEventListener(event: 'plugin-crashed', listener: (event: PluginCrashedEvent) => void): WebviewTag;
    /**
     * Fired when the WebContents is destroyed.
     */
    // addEventListener(event: 'destroyed', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'destroyed', listener: (event: Event) => void): WebviewTag;
    /**
     * Emitted when media starts playing.
     */
    // addEventListener(event: 'media-started-playing', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'media-started-playing', listener: (event: Event) => void): WebviewTag;
    /**
     * Emitted when media is paused or done playing.
     */
    // addEventListener(event: 'media-paused', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'media-paused', listener: (event: Event) => void): WebviewTag;
    /**
     * Emitted when a page's theme color changes. This is usually due to encountering a
     * meta tag:
     */
    ...
    //   useCapture?: boolean,
    // ): WebviewTag;
    // removeEventListener(event: 'did-change-theme-color', listener: (event: DidChangeThemeColorEvent) => void): WebviewTag;
    /**
     * Emitted when mouse moves over a link or the keyboard moves the focus to a link.
     */
    // addEventListener(
    ...
    //   useCapture?: boolean,
    // ): WebviewTag;
    // removeEventListener(event: 'update-target-url', listener: (event: UpdateTargetUrlEvent) => void): WebviewTag;
    /**
     * Emitted when DevTools is opened.
     */
    // addEventListener(event: 'devtools-opened', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'devtools-opened', listener: (event: Event) => void): WebviewTag;
    /**
     * Emitted when DevTools is closed.
     */
    // addEventListener(event: 'devtools-closed', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'devtools-closed', listener: (event: Event) => void): WebviewTag;
    /**
     * Emitted when DevTools is focused / opened.
     */
    // addEventListener(event: 'devtools-focused', listener: (event: Event) => void, useCapture?: boolean): WebviewTag;
    // removeEventListener(event: 'devtools-focused', listener: (event: Event) => void): WebviewTag;
    // addEventListener<K: $Keys<HTMLElementEventMap>>(
    //   type: K,
    //   listener: (ev: $ElementType<HTMLElementEventMap, K>) => any,
    //   useCapture?: boolean,
    // ): void;
    // addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    // removeEventListener<K: $Keys<HTMLElementEventMap>>(
    //   type: K,
    //   listener: (ev: $ElementType<HTMLElementEventMap, K>) => any,
    //   useCapture?: boolean,
    // ): void;
  ...
  declare interface AboutPanelOptionsOptions {
    /**
     * The app's name.
     */
  ...
  declare interface AddRepresentationOptions {
    /**
  ...
  declare interface AppDetailsOptions {
    /**
  ...
  declare interface BitmapOptions {
    /**
     * Defaults to 1.0.
     */
    scaleFactor?: number;
  ...
  declare interface BrowserViewConstructorOptions {
    /**
     * See .
     */
  ...
  declare interface CertificateTrustDialogOptions {
    /**
  ...
  declare interface CertificateVerifyProcRequest {
    hostname: string;
    certificate: Certificate;
    /**
  ...
  declare interface ConsoleMessageEvent extends Event {
    level: number;
    message: string;
    line: number;
    sourceId: string;
  ...
  declare interface CreateFromBufferOptions {
    /**
  ...
  declare interface DidChangeThemeColorEvent extends Event {
    themeColor: string;
  }

  declare interface DidFailLoadEvent extends Event {
    errorCode: number;
    errorDescription: string;
    validatedURL: string;
    isMainFrame: boolean;
  ...
  declare interface DidFrameFinishLoadEvent extends Event {
    isMainFrame: boolean;
  }

  declare interface DidGetRedirectRequestEvent extends Event {
    oldURL: string;
    newURL: string;
    isMainFrame: boolean;
  }

  declare interface DidGetResponseDetailsEvent extends Event {
    status: boolean;
    newURL: string;
    originalURL: string;
    httpResponseCode: number;
  ...
  declare interface DidNavigateEvent extends Event {
    url: string;
  }

  declare interface DidNavigateInPageEvent extends Event {
    isMainFrame: boolean;
    url: string;
  }

  declare interface DisplayBalloonOptions {
    icon?: NativeImage | string;
    title?: string;
    content?: string;
  }
  ...
  declare interface FileIconOptions {
  ...
  declare interface FoundInPageEvent extends Event {
  ...
  declare type HTMLElementEventMap = {
    "ariarequest": Event;
    "command": Event;
  ...
  declare interface InterceptBufferProtocolRequest {
    url: string;
    referrer: string;
    method: string;
  ...
  declare interface InterceptFileProtocolRequest {
    url: string;
    referrer: string;
    method: string;
    uploadData: UploadData[];
  ...
  declare interface InterceptHttpProtocolRequest {
    url: string;
    referrer: string;
    method: string;
    uploadData: UploadData[];
  ...
  declare interface InterceptStringProtocolRequest {
    url: string;
    referrer: string;
    method: string;
    uploadData: UploadData[];
  ...
  declare interface IpcMessageEvent extends Event {
    channel: string;
    args: any[];
  }
  ...
  declare interface LoadCommitEvent extends Event {
    url: string;
    isMainFrame: boolean;
  }
  ...
  declare interface LoginItemSettingsOptions {
    /**
  ...
  declare interface MenuItemConstructorOptions {
    /**
  ...
  declare interface NewWindowEvent extends Event {
    url: string;
    frameName: string;
    /**
     * Can be `default`, `foreground-tab`, `background-tab`, `new-window`,
  ...
  declare interface OnBeforeRedirectDetails {
    id: string;
    url: string;
    method: string;
    resourceType: string;
  ...
  declare interface OnBeforeRedirectFilter {
    /**
  ...
  declare interface OnBeforeRequestDetails {
    id: number;
    url: string;
    method: string;
    resourceType: string;
  ...
  declare interface OnBeforeRequestFilter {
    /**
     * Array of URL patterns that will be used to filter out the requests that do not
     * match the URL patterns.
     */
  ...
  declare interface OnBeforeSendHeadersFilter {
    /**
     * Array of URL patterns that will be used to filter out the requests that do not
     * match the URL patterns.
     */
  ...
  declare interface OnCompletedDetails {
    id: number;
    url: string;
    method: string;
    resourceType: string;
  ...
  declare interface OnCompletedFilter {
    /**
     * Array of URL patterns that will be used to filter out the requests that do not
     * match the URL patterns.
     */
  ...
  declare interface OnErrorOccurredDetails {
    id: number;
    url: string;
    method: string;
    resourceType: string;
  ...
  declare interface OnErrorOccurredFilter {
    /**
     * Array of URL patterns that will be used to filter out the requests that do not
     * match the URL patterns.
     */
  ...
  declare interface OnHeadersReceivedFilter {
    /**
     * Array of URL patterns that will be used to filter out the requests that do not
     * match the URL patterns.
     */
  ...
  declare interface OnResponseStartedDetails {
    id: number;
    url: string;
    method: string;
    resourceType: string;
  ...
  declare interface OnResponseStartedFilter {
    /**
     * Array of URL patterns that will be used to filter out the requests that do not
     * match the URL patterns.
     */
  ...
  declare interface OnSendHeadersDetails {
    id: number;
    url: string;
    method: string;
    resourceType: string;
  ...
  declare interface OnSendHeadersFilter {
    /**
     * Array of URL patterns that will be used to filter out the requests that do not
     * match the URL patterns.
     */
  ...
  declare interface OpenDevToolsOptions {
    /**
  ...
  declare interface OpenExternalOptions {
    /**
  ...
  declare interface PageFaviconUpdatedEvent extends Event {
    /**
     * Array of URLs.
     */
    favicons: string[];
  ...
  declare interface PageTitleUpdatedEvent extends Event {
    title: string;
    explicitSet: boolean;
  }
  ...
  declare interface PluginCrashedEvent extends Event {
    name: string;
    version: string;
  }
  ...
  declare interface ReadBookmark {
    title: string;
    url: string;
  }
  ...
  declare interface RegisterBufferProtocolRequest {
    url: string;
    referrer: string;
    method: string;
    uploadData: UploadData[];
  ...
  declare interface RegisterFileProtocolRequest {
    url: string;
    referrer: string;
    method: string;
    uploadData: UploadData[];
  ...
  declare interface RegisterHttpProtocolRequest {
    url: string;
    referrer: string;
    method: string;
    uploadData: UploadData[];
  ...
  declare interface RegisterStandardSchemesOptions {
    /**
  ...
  declare interface RegisterStringProtocolRequest {
    url: string;
    referrer: string;
    method: string;
    uploadData: UploadData[];
  ...
  declare interface RegisterURLSchemeAsPrivilegedOptions {
    /**
     * Default true.
     */
    secure?: boolean;
  ...
  declare interface RelaunchOptions {
    args?: string[];
    execPath?: string;
  }
  ...
  declare interface SourcesOptions {
    /**
  ...
  declare interface StartMonitoringOptions {
    categoryFilter: string;
    traceOptions: string;
  }

  declare interface StartRecordingOptions {
    categoryFilter: string;
    traceOptions: string;
  }
  ...
  declare interface ToBitmapOptions {
    /**
     * Defaults to 1.0.
     */
    scaleFactor?: number;
  ...
  declare interface ToPNGOptions {
    /**
     * Defaults to 1.0.
     */
    scaleFactor?: number;
  ...
  declare interface TouchBarButtonConstructorOptions {
    /**
     * Button text.
     */
    label?: string;
  ...
  declare interface TouchBarColorPickerConstructorOptions {
    /**
  ...
  declare interface TouchBarConstructorOptions {
    items: Array<
      | TouchBarButton
      | TouchBarColorPicker
      | TouchBarGroup
  ...
  declare interface TouchBarGroupConstructorOptions {
    /**
  ...
  declare interface TouchBarLabelConstructorOptions {
    /**
     * Text to display.
     */
    label?: string;
  ...
  declare interface TouchBarPopoverConstructorOptions {
    /**
     * Popover button text.
     */
    label?: string;
  ...
  declare interface TouchBarScrubberConstructorOptions {
    /**
  ...
  declare interface TouchBarSegmentedControlConstructorOptions {
    /**
  ...
  declare interface TouchBarSliderConstructorOptions {
    /**
     * Label text.
     */
    label?: string;
  ...
  declare interface TouchBarSpacerConstructorOptions {
    /**
  ...
  declare interface UpdateTargetUrlEvent extends Event {
    url: string;
  }
  ...
  declare interface WillNavigateEvent extends Event {
    url: string;
  }

  declare interface EditFlags {
    /**
  ...
  declare interface SelectionArea {}
