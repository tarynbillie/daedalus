...
export const toPercentage = (progress: SyncProgress): BigNumber =>
  progress.total.lessThanOrEqualTo(0) ? new BigNumber(0) : progress.completed.div(progress.total).mul(100);

export const difference = (progress: SyncProgress): BigNumber => progress.total.sub(progress.completed);

export const getEtcSyncProgress = (ethRpc: EthRpc): Promise<Maybe<SyncProgress>> =>
